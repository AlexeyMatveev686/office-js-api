...
Sets the border which will be displayed at the top of the current table cell.<br>Inherited From: [ApiTableCellPr#SetCellBorderTop](../../ApiTableCellPr/Methods/SetCellBorderTop.md)
